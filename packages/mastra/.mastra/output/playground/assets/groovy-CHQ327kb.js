...
function l() {
  if (s) return i;
  (s = 1), (i = n), (n.displayName = "groovy"), (n.aliases = []);
  function n(t) {
    (t.languages.groovy = t.languages.extend("clike", {
      ...
      t.hooks.add("wrap", (e) => {
        if (e.language === "groovy" && e.type === "string") {
          var o = e.content.value[0];
          if (o != "'") {
            var r = /([^\\])(?:\$(?:\{.*?\}|[\w.]+))/;
            o === "$" && (r = /([^$])(?:\$(?:\{.*?\}|[\w.]+))/),
              (e.content.value = e.content.value
                .replace(/&lt;/g, "<")
                .replace(/&amp;/g, "&")),
              (e.content = t.highlight(e.content.value, {
                expression: {
                  pattern: r,
                  lookbehind: !0,
              ...
              e.classes.push(o === "/" ? "regex" : "gstring");
          }
        }
      });
  }
...
var g = l();
const p = u(g),
  d = c({ __proto__: null, default: p }, [g]);
export { d as g };
