...
function l() {
  if (s) return i;
  (s = 1), (i = t), (t.displayName = "stan"), (t.aliases = []);
  function t(a) {
    ((r) => {
      var e =
      ...
      (r.languages.stan = {
        ...
        "function-arg": {
          pattern: RegExp(
            "(" + e.source + /\s*\(\s*/.source + ")" + /[a-zA-Z]\w*/.source
          ),
          lookbehind: !0,
          alias: "function",
        },
        ...
        (r.languages.stan.constraint.inside.expression.inside =
          r.languages.stan);
    })(a);
  }
  return i;
...
var c = l();
const _ = d(c),
  b = u({ __proto__: null, default: _ }, [c]);
export { b as s };
