import { g as i } from "./index-DNVQAxgB.js";
import { r as d } from "./markup-templating-BxAVv-bL.js";
...
function g() {
  ...
  l = 1;
  var n = d();
  (o = r), (r.displayName = "handlebars"), (r.aliases = ["hbs"]);
  function r(t) {
    t.register(n),
      ((e) => {
...
var u = g();
const p = i(u),
  h = b({ __proto__: null, default: p }, [u]);
export { h };
