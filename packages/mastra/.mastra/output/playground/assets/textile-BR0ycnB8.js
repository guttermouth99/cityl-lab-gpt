import { g as h } from "./index-DNVQAxgB.js";
...
function O() {
  ...
  function r(l) {
    ((i) => {
      ...
      var s = {
          css: { pattern: /\{[^{}]+\}/, inside: { rest: i.languages.css } },
          "class-id": {
            pattern: /(\()[^()]+(?=\))/,
            lookbehind: !0,
            alias: "attr-value",
...
var b = O();
const M = h(b),
  x = g({ __proto__: null, default: M }, [b]);
export { x as t };
