      ...
      Object.defineProperties((f.languages["markup-templating"] = {}), {
        buildPlaceholders: {
          value(a, t, o, p) {
            if (a.language === t) {
              var u = (a.tokenStack = []);
              (a.code = a.code.replace(o, (n) => {
                if (typeof p == "function" && !p(n)) return n;
                for (
                  var i = u.length, r;
                  a.code.indexOf((r = k(t, i))) !== -1;
                )
                  ++i;
                return (u[i] = n), r;
              })),
            ...
            function u(n) {
              for (var i = 0; i < n.length && !(o >= p.length); i++) {
                ...
                if (
                  ...
                  var y = p[o],
                    d = a.tokenStack[y],
                    l = typeof r == "string" ? r : r.content,
                    h = k(t, y),
                    g = l.indexOf(h);
                  if (g > -1) {
                    ++o;
                    var v = l.substring(0, g),
                      b = new f.Token(
                        t,
                        f.tokenize(d, a.grammar),
                        "language-" + t,
                        d
                      ),
                      T = l.substring(g + h.length),
                      e = [];
                    v && e.push.apply(e, u([v])),
                      e.push(b),
                      T && e.push.apply(e, u([T])),
                      typeof r == "string"
                        ? n.splice.apply(n, [i, 1].concat(e))
                        : (r.content = e);
                  }
