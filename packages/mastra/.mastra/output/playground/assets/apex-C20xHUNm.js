...
import { r as d } from "./sql-CJATM1Qp.js";
...
function f() {
  ...
  c = 1;
  var a = d();
  (l = r), (r.displayName = "apex"), (r.aliases = []);
  function r(n) {
    n.register(a),
      ((e) => {
        var t =
        ...
        e.languages.apex = {
          ...
          "class-name": [
            ...
            {
              pattern: s(/(\(\s*)<CLASS-NAME>(?=\s*\)\s*[\w(])/.source),
              lookbehind: !0,
              inside: o,
            },
            {
...
var u = f();
const m = g(u),
  y = b({ __proto__: null, default: m }, [u]);
export { y as a };
