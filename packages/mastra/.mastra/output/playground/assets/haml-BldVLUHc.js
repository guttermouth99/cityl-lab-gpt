import { g as c } from "./index-DNVQAxgB.js";
    ...
    a.register(l),
      ((e) => {
        ...
        for (
          ...
          var t = i[o];
          (t = typeof t == "string" ? { filter: t, language: t } : t),
            e.languages[t.language] &&
              (s["filter-" + t.filter] = {
                pattern: RegExp(r.replace("{{filter_name}}", () => t.filter)),
                lookbehind: !0,
                inside: {
...
var p = m();
const h = c(p),
  v = b({ __proto__: null, default: h }, [p]);
export { v as h };
