import { g as T } from "./index-DNVQAxgB.js";
...
function x() {
  if (h) return b;
  (h = 1), (b = s), (s.displayName = "sas"), (s.aliases = []);
  function s(c) {
    ((r) => {
      var t = /(?:"(?:""|[^"])*"(?!")|'(?:''|[^'])*'(?!'))/.source,
        e = /\b(?:\d[\da-f]*x|\d+(?:\.\d+)?(?:e[+-]?\d+)?)\b/i,
        ...
        v = {
          ...
          inside: {
            keyword: RegExp(
              /(?:<act>)\.[a-z]+\b/.source.replace(/<act>/g, () => w),
              "i"
            ),
...
var E = x();
const N = T(E),
  L = R({ __proto__: null, default: N }, [E]);
export { L as s };
