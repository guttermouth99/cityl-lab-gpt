import { g as S } from "./index-DNVQAxgB.js";
...
function C() {
  if (_) return m;
  (_ = 1), (m = l), (l.displayName = "markdown"), (l.aliases = ["md"]);
  function l(b) {
    ((e) => {
      var s = /(?:\\.|[^\\\n\r]|(?:\n|\r\n?)(?![\r\n]))/.source;
      function o(t) {
        return (
          (t = t.replace(/<inner>/g, () => s)),
          RegExp(/((?:^|[^\\])(?:\\{2})*)/.source + "(?:" + t + ")")
        );
      }
      var d = /(?:\\.|``(?:[^`\r\n]|`(?!`))+``|`[^`\r\n]+`|[^\\|\r\n`])+/
      ...
      (e.languages.markdown = e.languages.extend("markup", {})),
        ...
        ["url", "bold", "italic", "strike"].forEach((t) => {
        ...
        e.hooks.add("after-tokenize", (t) => {
          if (t.language !== "markdown" && t.language !== "md") return;
          function n(i) {
        ...
        e.hooks.add("wrap", (t) => {
          if (t.type === "code-block") {
            ...
            var g = e.languages[n];
            if (g) t.content = e.highlight($(t.content.value), g, n);
              ...
              (t.attributes.id = a),
                e.plugins.autoloader.loadLanguages(n, () => {
                  var c = document.getElementById(a);
                  c &&
                    (c.innerHTML = e.highlight(
                      c.textContent,
                      e.languages[n],
                      n
                    ));
      ...
      var y = RegExp(e.languages.markup.tag.pattern.source, "gi"),
        v = { amp: "&", lt: "<", gt: ">", quot: '"' },
        x = String.fromCodePoint || String.fromCharCode;
      function $(t) {
        var n = t.replace(y, "");
        return (
          (n = n.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, (i, r) => {
            if (((r = r.toLowerCase()), r[0] === "#")) {
              var p;
              return (
                r[1] === "x"
                  ? (p = Number.parseInt(r.slice(2), 16))
                  : (p = Number(r.slice(1))),
                x(p)
              );
            }
...
var w = C();
const R = S(w),
  N = E({ __proto__: null, default: R }, [w]);
export { N as m };
