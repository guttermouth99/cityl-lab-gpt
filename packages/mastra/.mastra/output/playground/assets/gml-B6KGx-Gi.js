import { g as _ } from "./index-DNVQAxgB.js";
...
function c() {
  if (s) return n;
  (s = 1), (n = e), (e.displayName = "gml"), (e.aliases = []);
  function e(t) {
    t.languages.gamemakerlanguage = t.languages.gml = t.languages.extend(
      "clike",
      {
        keyword:
...
var l = c();
const p = _(l),
  m = d({ __proto__: null, default: p }, [l]);
export { m as g };
