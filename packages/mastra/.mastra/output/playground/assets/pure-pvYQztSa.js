import { g as u } from "./index-DNVQAxgB.js";
...
function f() {
  if (s) return l;
  (s = 1), (l = r), (r.displayName = "pure"), (r.aliases = []);
  function r(p) {
    ((e) => {
      e.languages.pure = {
        comment: [
      ...
      var a = ["c", { lang: "c++", alias: "cpp" }, "fortran"],
        n = /%< *-\*- *<lang>\d* *-\*-[\s\S]+?%>/.source;
      a.forEach((t) => {
        var i = t;
        if (
          (typeof t != "string" && ((i = t.alias), (t = t.lang)),
          e.languages[i])
        ) {
          var o = {};
          (o["inline-lang-" + i] = {
            pattern: RegExp(
              n.replace("<lang>", t.replace(/([.+*?/\\(){}[\]])/g, "\\$1")),
              "i"
            ),
            inside: e.util.clone(e.languages.pure["inline-lang"].inside),
          }),
            (o["inline-lang-" + i].inside.rest = e.util.clone(e.languages[i])),
...
var c = f();
const g = u(c),
  b = d({ __proto__: null, default: g }, [c]);
export { b as p };
