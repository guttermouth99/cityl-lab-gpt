  ...
  function y(z) {
    ((t) => {
      ...
      var w = d(n.typeDeclaration),
        ...
        j = d(n.typeDeclaration + " " + n.contextual + " " + n.other),
        q = d(n.type + " " + n.typeDeclaration + " " + n.other),
        g = l(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2),
        h = l(/\((?:[^()]|<<self>>)*\)/.source, 2),
        o = /@?\b[A-Za-z_]\w*\b/.source,
        b = r(/<<0>>(?:\s*<<1>>)?/.source, [o, g]),
        i = r(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [j, b]),
        v = /\[\s*(?:,\s*)*\]/.source,
        A = r(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [i, v]),
        N = r(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [g, h, v]),
        O = r(/\(<<0>>+(?:,<<0>>+)+\)/.source, [N]),
        c = r(/(?:<<0>>|<<1>>)(?:\s*(?:\?\s*)?<<2>>)*(?:\s*\?)?/.source, [
          O,
          i,
          v,
        ]),
        a = { keyword: p, punctuation: /[<>()?,.:[\]]/ },
      ...
      (t.languages.csharp = t.languages.extend("clike", {
        ...
        "class-name": [
          ...
          { pattern: e(/(\bwhere\s+)<<0>>/.source, [o]), lookbehind: !0 },
          {
        ...
        t.languages.insertBefore("csharp", "class-name", {
          ...
          "generic-method": {
            pattern: e(/<<0>>\s*<<1>>(?=\s*\()/.source, [o, g]),
            inside: {
              function: e(/^<<0>>/.source, [o]),
              generic: { pattern: RegExp(g), alias: "class-name", inside: a },
            },
          },
          "type-list": {
            pattern: e(
              /\b((?:<<0>>\s+<<1>>|record\s+<<1>>\s*<<5>>|where\s+<<2>>)\s*:\s*)(?:<<3>>|<<4>>|<<1>>\s*<<5>>|<<6>>)(?:\s*,\s*(?:<<3>>|<<4>>|<<6>>))*(?=\s*(?:where|[{;]|=>|$))/
                .source,
              [w, b, o, c, p.source, h, /\bnew\s*\(\s*\)/.source]
            ),
            lookbehind: !0,
            inside: {
              "record-arguments": {
                pattern: e(/(^(?!new\s*\()<<0>>\s*)<<1>>/.source, [b, h]),
                lookbehind: !0,
                greedy: !0,
                inside: t.languages.csharp,
              },
              keyword: p,
              "class-name": { pattern: RegExp(c), greedy: !0, inside: a },
              punctuation: /[,()]/,
            },
          },
          preprocessor: {
