import { g as m } from "./index-DNVQAxgB.js";
...
function x() {
  if (h) return l;
  (h = 1), (l = a), (a.displayName = "qsharp"), (a.aliases = ["qs"]);
  function a(o) {
    ((n) => {
      function t(r, i) {
        return r.replace(/<<(\d+)>>/g, (u, w) => "(?:" + i[+w] + ")");
      }
      function e(r, i, u) {
        return RegExp(t(r, i), "");
      }
      ...
      var g = RegExp(q(p.type + " " + p.other)),
        v = /\b[A-Za-z_]\w*\b/.source,
        c = t(/<<0>>(?:\s*\.\s*<<0>>)*/.source, [v]),
        d = { keyword: g, punctuation: /[<>()?,.:[\]]/ },
        f = /"(?:\\.|[^\\"])*"/.source;
      (n.languages.qsharp = n.languages.extend("clike", {
        ...
        "class-name": [
          {
            pattern: e(/(\b(?:as|open)\s+)<<0>>(?=\s*(?:;|as\b))/.source, [c]),
            lookbehind: !0,
            inside: d,
          },
          {
            pattern: e(/(\bnamespace\s+)<<0>>(?=\s*\{)/.source, [c]),
            lookbehind: !0,
            inside: d,
          },
        ],
      ...
      (o.languages.qs = o.languages.qsharp);
  }
  return l;
}
var y = x();
const j = m(y),
  _ = k({ __proto__: null, default: j }, [y]);
export { _ as q };
