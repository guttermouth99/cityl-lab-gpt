import { g as b } from "./index-DNVQAxgB.js";
...
function $() {
  if (u) return l;
  (u = 1), (l = a), (a.displayName = "asciidoc"), (a.aliases = ["adoc"]);
  function a(o) {
    ((r) => {
      var n = {
          pattern:
      ...
      function e(i) {
        i = i.split(" ");
        for (var c = {}, s = 0, d = i.length; s < d; s++) c[i[s]] = t[i[s]];
        return c;
      }
      (n.inside.interpreted.inside.rest = e("macro inline replacement entity")),
        (t["passthrough-block"].inside.rest = e("macro")),
        (t["literal-block"].inside.rest = e("callout")),
        (t.table.inside.rest = e(
          "comment-block passthrough-block literal-block other-block list-punctuation indented-block comment title attribute-entry attributes hr page-break admonition list-label callout macro inline replacement entity line-continuation"
        )),
        (t["other-block"].inside.rest = e(
          "table list-punctuation indented-block comment attribute-entry attributes hr page-break admonition list-label macro inline replacement entity line-continuation"
        )),
        (t.title.inside.rest = e("macro inline replacement entity")),
        r.hooks.add("wrap", (i) => {
          i.type === "entity" &&
...
var p = $();
const f = b(p),
  h = m({ __proto__: null, default: f }, [p]);
export { h as a };
