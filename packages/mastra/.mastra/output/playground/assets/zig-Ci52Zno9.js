import { g as p } from "./index-DNVQAxgB.js";
...
function m() {
  if (c) return l;
  (c = 1), (l = n), (n.displayName = "zig"), (n.aliases = []);
  function n(o) {
    ((t) => {
      function e(s) {
        return () => s;
      ...
      (t.languages.zig = {
        ...
        t.languages.zig["class-name"].forEach((s) => {
          s.inside === null && (s.inside = t.languages.zig);
        });
    })(o);
  }
  return l;
...
var d = m();
const y = p(d),
  E = f({ __proto__: null, default: y }, [d]);
export { E as z };
