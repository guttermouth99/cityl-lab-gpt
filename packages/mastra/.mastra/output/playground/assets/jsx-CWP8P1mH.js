        ...
        f = (e) => {
          for (var t = [], s = 0; s < e.length; s++) {
            ...
            if (
              (typeof n != "string" &&
                (n.type === "tag" && n.content[0] && n.content[0].type === "tag"
                  ? n.content[0].content[0].content === "</"
                    ? t.length > 0 &&
                      t[t.length - 1].tagName === g(n.content[0].content[1]) &&
                      t.pop()
              ...
              s < e.length - 1 &&
                (typeof e[s + 1] == "string" ||
                  e[s + 1].type === "plain-text") &&
                ((r += g(e[s + 1])), e.splice(s + 1, 1)),
                s > 0 &&
                  (typeof e[s - 1] == "string" ||
                    e[s - 1].type === "plain-text") &&
                  ((r = g(e[s - 1]) + r), e.splice(s - 1, 1), s--),
                (e[s] = new a.Token("plain-text", r, null, r));
            }
