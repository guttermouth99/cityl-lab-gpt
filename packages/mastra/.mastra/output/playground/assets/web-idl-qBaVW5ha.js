...
function c() {
  if (l) return o;
  (l = 1), (o = a), (a.displayName = "webIdl"), (a.aliases = []);
  function a(i) {
    ((n) => {
      var e = /(?:\B-|\b_|\b)[A-Za-z][\w-]*(?![\w-])/.source,
        r =
          "(?:" +
      ...
      n.languages["web-idl"] = {
        ...
        "class-name": [
          ...
          {
            pattern: RegExp(
              "(" + /\bcallback\s+/.source + e + /\s*=\s*/.source + ")" + r
            ),
            lookbehind: !0,
            inside: t,
          },
          {
            pattern: RegExp(/(\btypedef\b\s*)/.source + r),
            lookbehind: !0,
            inside: t,
          },
          {
          ...
          { pattern: RegExp(/(:\s*)/.source + e), lookbehind: !0 },
      ...
      for (var s in n.languages["web-idl"])
        s !== "class-name" && (t[s] = n.languages["web-idl"][s]);
...
var u = c();
const p = b(u),
  y = d({ __proto__: null, default: p }, [u]);
export { y as w };
