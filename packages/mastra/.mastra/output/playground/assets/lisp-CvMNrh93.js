import { g as k } from "./index-DNVQAxgB.js";
    ...
    ((r) => {
      ...
      var e = /(?!\d)[-+*/~!@$%^=<>{}\w]+/.source,
        ...
        t = {
          ...
          "lisp-property": { pattern: RegExp(":" + e), alias: "property" },
          splice: { pattern: RegExp(",@?" + e), alias: ["symbol", "variable"] },
          keyword: [
            {
              pattern: RegExp(
                o +
            ...
            {
              pattern: RegExp(
                o + "(?:append|by|collect|concat|do|finally|for|in|return)" + b
              ),
              lookbehind: !0,
            },
          ],
          ...
          defvar: {
            ...
            lookbehind: !0,
            inside: { keyword: /^def[a-z]+/, variable: RegExp(e) },
          },
          defun: {
            pattern: RegExp(
              o +
            ...
            inside: {
              keyword: /^(?:cl-)?def\S+/,
              arguments: null,
              function: { pattern: RegExp("(^\\s)" + e), lookbehind: !0 },
              punctuation: /[()]/,
            },
          },
          lambda: {
            pattern: RegExp(
              o + "lambda\\s+\\(\\s*(?:&?" + e + "(?:\\s+&?" + e + ")*\\s*)?\\)"
            ),
            lookbehind: !0,
            greedy: !0,
            inside: {
          ...
          car: { pattern: RegExp(o + e), lookbehind: !0 },
          punctuation: [
            /(?:['`,]?\(|[)[\]])/,
        ...
        d = {
          ...
          inside: {
            ...
            argument: { pattern: RegExp(e), alias: "variable" },
            punctuation: /[()]/,
          },
        };
      (t.lambda.inside.arguments = d),
        (t.defun.inside.arguments = r.util.clone(d)),
        (t.defun.inside.arguments.inside.sublist = d),
        (r.languages.lisp = t),
        (r.languages.elisp = t),
        (r.languages.emacs = t),
        (r.languages["emacs-lisp"] = t);
    })(i);
  }
  return g;
}
var f = E();
const R = k(f),
  w = x({ __proto__: null, default: R }, [f]);
export { w as l };
