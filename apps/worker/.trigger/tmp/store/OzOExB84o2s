import { __esm, __export, __name, init_esm } from "./chunk-CEVTQX7C.mjs";

// ../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/platform/node/globalThis.js
var _globalThis;
...
// ../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/platform/node/index.js
var init_node = __esm({
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/platform/node/index.js"() {
    init_esm();
    init_globalThis();
...
// ../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/platform/index.js
      ...
      (() => {
        function DiagAPI2() {
          ...
          var setLogger = /* @__PURE__ */ __name(
            (logger, optionsOrLogLevel) => {
              ...
              if (oldLogger && !optionsOrLogLevel.suppressOverrideMessage) {
                ...
                oldLogger.warn(
                  "Current logger will be overwritten from " + stack
                );
                newLogger.warn(
          ...
          this.createComponentLogger = (options) =>
            new DiagComponentLogger(options);
    ...
    BaggageImpl =
      ...
      (() => {
        ...
        BaggageImpl2.prototype.getAllEntries = function () {
          return Array.from(this._entries.entries()).map((_a) => {
            var _b = __read3(_a, 2),
              k = _b[0],
              v = _b[1];
            return [k, v];
        ...
        BaggageImpl2.prototype.clear = () => new BaggageImpl2();
        return BaggageImpl2;
      })();
  },
});
...
function baggageEntryMetadataFromString(str) {
  ...
  return {
    ...
    toString: /* @__PURE__ */ __name(() => str, "toString"),
  };
}
var diag;
    ...
    BaseContext =
      ...
      /* @__PURE__ */ (() => {
        function BaseContext2(parentContext) {
          this._currentContext = parentContext
            ? new Map(parentContext)
            : /* @__PURE__ */ new Map();
          this.getValue = (key) => this._currentContext.get(key);
          this.setValue = (key, value) => {
            var context2 = new BaseContext2(this._currentContext);
...
var init_NoopMeter = __esm({
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/metrics/NoopMeter.js"() {
    init_esm();
    __extends = /* @__PURE__ */ (() => {
      var extendStatics = /* @__PURE__ */ __name((d, b) => {
        extendStatics =
          ...
          ((d2, b2) => {
            for (var p in b2) if (Object.hasOwn(b2, p)) d2[p] = b2[p];
          });
    ...
    NoopMeter =
      ...
      (() => {
        ...
        NoopMeter2.prototype.createGauge = (_name, _options) =>
          NOOP_GAUGE_METRIC;
        NoopMeter2.prototype.createHistogram = (_name, _options) =>
          NOOP_HISTOGRAM_METRIC;
        NoopMeter2.prototype.createCounter = (_name, _options) =>
          NOOP_COUNTER_METRIC;
        NoopMeter2.prototype.createUpDownCounter = (_name, _options) =>
          NOOP_UP_DOWN_COUNTER_METRIC;
        NoopMeter2.prototype.createObservableGauge = (_name, _options) =>
          NOOP_OBSERVABLE_GAUGE_METRIC;
        NoopMeter2.prototype.createObservableCounter = (_name, _options) =>
          NOOP_OBSERVABLE_COUNTER_METRIC;
        NoopMeter2.prototype.createObservableUpDownCounter = (
          _name,
          _options
        ) => NOOP_OBSERVABLE_UP_DOWN_COUNTER_METRIC;
        NoopMeter2.prototype.addBatchObservableCallback = (
          _callback,
          _observables
        ) => {};
        NoopMeter2.prototype.removeBatchObservableCallback = (_callback) => {};
        return NoopMeter2;
      })();
    NoopMetric =
      /** @class */
    ...
    NoopCounterMetric =
      ...
      ((_super) => {
        ...
        NoopCounterMetric2.prototype.add = (_value, _attributes) => {};
    ...
    NoopUpDownCounterMetric =
      ...
      ((_super) => {
        ...
        NoopUpDownCounterMetric2.prototype.add = (_value, _attributes) => {};
    ...
    NoopGaugeMetric =
      ...
      ((_super) => {
        ...
        NoopGaugeMetric2.prototype.record = (_value, _attributes) => {};
    ...
    NoopHistogramMetric =
      ...
      ((_super) => {
        ...
        NoopHistogramMetric2.prototype.record = (_value, _attributes) => {};
    ...
    NoopObservableMetric =
      ...
      (() => {
        ...
        NoopObservableMetric2.prototype.addCallback = (_callback) => {};
        NoopObservableMetric2.prototype.removeCallback = (_callback) => {};
...
var init_TextMapPropagator = __esm({
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/propagation/TextMapPropagator.js"() {
    ...
    defaultTextMapSetter = {
      set: /* @__PURE__ */ __name((carrier, key, value) => {
        if (carrier == null) {
          return;
        }
        carrier[key] = value;
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/context/NoopContextManager.js"() {
    ...
    NoopContextManager =
      ...
      (() => {
        ...
        NoopContextManager2.prototype.active = () => ROOT_CONTEXT;
        NoopContextManager2.prototype.with = function (_context, fn, thisArg) {
          ...
          return fn.call.apply(
            fn,
            __spreadArray3([thisArg], __read4(args), false)
          );
        };
        NoopContextManager2.prototype.bind = (_context, target) => target;
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/api/context.js"() {
    ...
    ContextAPI =
      ...
      (() => {
        ...
        ContextAPI2.prototype.setGlobalContextManager = (contextManager) =>
          registerGlobal(API_NAME2, contextManager, DiagAPI.instance());
        ...
        ContextAPI2.prototype.with = function (context2, fn, thisArg) {
          ...
          return (_a = this._getContextManager()).with.apply(
            _a,
        ...
        ContextAPI2.prototype._getContextManager = () =>
          getGlobal(API_NAME2) || NOOP_CONTEXT_MANAGER;
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/trace/NonRecordingSpan.js"() {
    ...
    NonRecordingSpan =
      ...
      (() => {
        ...
        NonRecordingSpan2.prototype.end = (_endTime) => {};
        NonRecordingSpan2.prototype.isRecording = () => false;
        NonRecordingSpan2.prototype.recordException = (_exception, _time) => {};
...
function getSpanContext(context2) {
  var _a;
  return (_a = getSpan(context2)) === null || _a === void 0
    ? void 0
    : _a.spanContext();
}
var SPAN_KEY;
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/trace/NoopTracer.js"() {
    ...
    NoopTracer =
      ...
      (() => {
        ...
        NoopTracer2.prototype.startSpan = (name, options, context2) => {
          if (context2 === void 0) {
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/trace/NoopTracerProvider.js"() {
    ...
    NoopTracerProvider =
      ...
      (() => {
        ...
        NoopTracerProvider2.prototype.getTracer = (_name, _version, _options) =>
          new NoopTracer();
    ...
    ProxyTracerProvider =
      ...
      (() => {
        ...
        ProxyTracerProvider2.prototype.getTracer = function (
          ...
          var _a;
          return (_a = this.getDelegateTracer(name, version, options)) !==
            null && _a !== void 0
            ? _a
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/metrics/NoopMeterProvider.js"() {
    ...
    NoopMeterProvider =
      ...
      (() => {
        ...
        NoopMeterProvider2.prototype.getMeter = (_name, _version, _options) =>
          NOOP_METER;
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/api/metrics.js"() {
    ...
    MetricsAPI =
      ...
      (() => {
        ...
        MetricsAPI2.prototype.setGlobalMeterProvider = (provider) =>
          registerGlobal(API_NAME3, provider, DiagAPI.instance());
        MetricsAPI2.prototype.getMeterProvider = () =>
          getGlobal(API_NAME3) || NOOP_METER_PROVIDER;
        MetricsAPI2.prototype.getMeter = function (name, version, options) {
          return this.getMeterProvider().getMeter(name, version, options);
        };
        MetricsAPI2.prototype.disable = () => {
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/propagation/NoopTextMapPropagator.js"() {
    ...
    NoopTextMapPropagator =
      ...
      (() => {
        ...
        NoopTextMapPropagator2.prototype.inject = (_context, _carrier) => {};
        NoopTextMapPropagator2.prototype.extract = (context2, _carrier) =>
          context2;
        NoopTextMapPropagator2.prototype.fields = () => [];
  ...
  "../../../../../../../private/tmp/bunx-501-trigger.dev@latest/node_modules/@opentelemetry/api/build/esm/api/propagation.js"() {
    ...
    PropagationAPI =
      ...
      (() => {
        ...
        PropagationAPI2.prototype.setGlobalPropagator = (propagator) =>
          registerGlobal(API_NAME4, propagator, DiagAPI.instance());
        ...
        PropagationAPI2.prototype.disable = () => {
          unregisterGlobal(API_NAME4, DiagAPI.instance());
        };
        PropagationAPI2.prototype._getGlobalPropagator = () =>
          getGlobal(API_NAME4) || NOOP_TEXT_MAP_PROPAGATOR;
...
//# sourceMappingURL=chunk-6L5SD3AS.mjs.map
