...
var require_react_production = __commonJS({
  "../../node_modules/react/cjs/react.production.js"(exports) {
    ...
    var ReactNoopUpdateQueue = {
      isMounted: /* @__PURE__ */ __name(() => false, "isMounted"),
      enqueueForceUpdate: /* @__PURE__ */ __name(
        () => {},
        "enqueueForceUpdate"
      ),
      enqueueReplaceState: /* @__PURE__ */ __name(
        () => {},
        "enqueueReplaceState"
      ),
      enqueueSetState: /* @__PURE__ */ __name(() => {}, "enqueueSetState"),
    };
    ...
    var Children = {
      ...
      count: /* @__PURE__ */ __name((children) => {
        var n = 0;
      ...
      toArray: /* @__PURE__ */ __name(
        (children) => mapChildren(children, (child) => child) || [],
        "toArray"
      ),
      only: /* @__PURE__ */ __name((children) => {
    ...
    exports.__COMPILER_RUNTIME = {
      __proto__: null,
      c: /* @__PURE__ */ __name(
        (size) => ReactSharedInternals.H.useMemoCache(size),
        "c"
      ),
    };
    exports.cache = (fn) =>
    ...
    exports.unstable_useCacheRefresh = () =>
      ReactSharedInternals.H.useCacheRefresh();
    ...
    exports.useCallback = (callback, deps) =>
      ReactSharedInternals.H.useCallback(callback, deps);
    exports.useContext = (Context) =>
      ReactSharedInternals.H.useContext(Context);
    ...
    exports.useEffect = (create, deps) =>
      ReactSharedInternals.H.useEffect(create, deps);
    exports.useEffectEvent = (callback) =>
      ReactSharedInternals.H.useEffectEvent(callback);
    ...
    exports.useMemo = (create, deps) =>
      ReactSharedInternals.H.useMemo(create, deps);
    ...
    exports.useRef = (initialValue) =>
      ReactSharedInternals.H.useRef(initialValue);
    exports.useState = (initialState) =>
      ReactSharedInternals.H.useState(initialState);
    ...
    process.env.NODE_ENV !== "production" &&
      (() => {
        ...
        function ReactElement(type, key, props, owner, debugStack, debugTask) {
          ...
          (void 0 !== refProp ? refProp : null) !== null
        ...
        function validateChildKeys(node) {
          isValidElement(node)
            ...
            : typeof node === "object" &&
              ...
              (node._payload.status === "fulfilled"
        ...
        function enqueueTask(task) {
          if (enqueueTaskImpl === null)
            try {
              ...
              enqueueTaskImpl = /* @__PURE__ */ __name((callback) => {
        ...
        function aggregateErrors(errors) {
          return errors.length > 1 && typeof AggregateError === "function"
        ...
        var REACT_ELEMENT_TYPE = Symbol.for("react.transitional.element"),
          ...
          ReactNoopUpdateQueue = {
            isMounted: /* @__PURE__ */ __name(() => false, "isMounted"),
            enqueueForceUpdate: /* @__PURE__ */ __name((publicInstance) => {
              warnNoop(publicInstance, "forceUpdate");
            }, "enqueueForceUpdate"),
            enqueueReplaceState: /* @__PURE__ */ __name((publicInstance) => {
              warnNoop(publicInstance, "replaceState");
            }, "enqueueReplaceState"),
            enqueueSetState: /* @__PURE__ */ __name((publicInstance) => {
        ...
        deprecatedAPIs = {
          react_stack_bottom_frame: /* @__PURE__ */ __name(
            (callStackForError) => callStackForError(),
        ...
        deprecatedAPIs = Object.freeze({
          __proto__: null,
          c: /* @__PURE__ */ __name(
            (size) => resolveDispatcher().useMemoCache(size),
            "c"
          ),
        });
        var fnName = {
        ...
        exports.createElement = function (type, config, children) {
          ...
          var propName =
            ReactSharedInternals.recentlyCreatedOwnerStacks++ < 1e4;
          return ReactElement(
            type,
            key,
            i,
        ...
        exports.forwardRef = (render) => {
          ...
          Object.defineProperty(elementType, "displayName", {
            enumerable: false,
            configurable: true,
            get: /* @__PURE__ */ __name(() => ownName, "get"),
            set: /* @__PURE__ */ __name((name) => {
              ownName = name;
              render.name ||
                render.displayName ||
...
react/cjs/react.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-F5GHDP45.mjs.map
